        ...
        {showSuccess && (
          ...
          >
            ...
            >
              ...
              >
                Welcome back to E-Nena Pahana. You're now ready to continue your learning journey.
              </motion.p>
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center p-8 relative z-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center text-white p-8 lg:p-12">
          ...
          >
            ...
            <h1 className="text-4xl font-bold mb-6 text-center">Welcome to E-Nena Pahana</h1>
            <p className="text-lg text-white/90 mb-12 text-center">
              Your journey to academic excellence starts here. Access quality educational resources and enhance your learning experience.
            </p>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          ...
          >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-white/30 bg-white/20 text-[#2800aa] focus:ring-white/50 transition-colors duration-300"
                  />
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="text-white hover:text-white/80 transition-colors duration-300">
                    Forgot password?
                  </Link>
                </div>
              </div>
            ...
            >
              ...
              <Link to="/signup" className="text-white font-semibold hover:text-white/80 transition-colors duration-300">
                Sign up
              </Link>
            </motion.div>
          </motion.div>
